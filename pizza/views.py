...
def order(request):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
            ...
            note = 'Thanks for ordering your %s , %s and %s pizza.'%(filled_form.cleaned_data['size'],
            filled_form.cleaned_data['topping1'],
            filled_form.cleaned_data['topping2'],
            )
            filled_form= PizzaForm()
        else :
            note= 'Order did not go through! Please try again ' 
...
def pizzas(request):
    ...
    if request.method == 'POST':
        ...
        if filled_formset.is_valid():
            ...
            note= 'Orders was not created, please try again '
...
def edit_order(request, pk):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
            filled_form.save()
            form = filled_form
            note ='Your order has been updated with %s' %(filled_form.cleaned_data['topping1'])  
